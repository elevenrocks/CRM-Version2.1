...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityBody").on("click",$("input[name=chk]"),function () {
			$("#allCheck").prop("checked",$("input[name=chk]").length==$("input[name=chk]:checked").length);
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.dataList,function (i,n) {
					...
					html += '<td><input type="checkbox" name="chk" value="'+n.id+'" /></td>';
...
<body>
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div style="height: 50px; position: relative;top: 30px; color: #00B83F;">
